...
$items = query("SELECT * FROM category WHERE ctg_id = $id")[0];
		...
		<div id="main" class="container mw-100 p-5">
         ...
         <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
               ...
               <input required type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="ctg_name" value="<?= $items['ctg_name']; ?>">
            </div>
            
            <div class="form-group">
               <label for="exampleFormControlTextarea1">Deskripsi</label>
               <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name="ctg_desc"><?= $items['ctg_desc']; ?></textarea>
            </div>
