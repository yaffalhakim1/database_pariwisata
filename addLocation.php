...
if(isset($_POST['add'])){
   // var_dump($_FILES);
		...
		if(createLoc($_POST) > 0){
			echo "<script>
					alert('New Location Succesfully Added');
					document.location.href = 'location.php';
				</script>";
		}elseif( createLoc($_POST) <= 0 ){
			echo "<script>
					alert('Failed create new Location');
               document.location.href = 'addLocation.php';
				</script>";	
		}
	}
		...
		<div id="main" class="container mw-100 p-5">
         ...
         <form action="" method="POST" enctype="multipart/form-data">
            <div class="form-group">
               ...
               <input required type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="loc_name">
            </div>
